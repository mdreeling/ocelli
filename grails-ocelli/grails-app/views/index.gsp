	...
	<body class="desktop-detected" style="">
		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul style="">
					...
					<li class="active">
						<a href="application/index"><i class="fa fa-lg fa-fw fa-inbox"></i> <span class="menu-item-parent">Applications</span></a>
					</li>
					...
					<li class="top-menu-hidden open">
						<a href="#"><i class="fa fa-lg fa-fw fa-cube txt-color-blue"></i> <span class="menu-item-parent">OcelliServer Intel</span><b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b><b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b><b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b><b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b><b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b><b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b></a>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb"><li>Home</li><li>Applications</li></ol>
				<!-- end breadcrumb -->
...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
			...
			<div class="jarviswidget jarviswidget-color-greenDark jarviswidget-sortable" id="wid-id-2" data-widget-editbutton="false" role="widget" style="">
				...
				<div role="content">
					...
					<div class="widget-body no-padding">
						...
						<div class="alert alert-info no-margin fade in">
							...
							Applications available for monitoring are shown below
						</div>
		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white">Ocelli Server © 2013-2014</span>
				</div>
...
<div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><ul class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content ui-corner-all" id="ui-id-1" tabindex="0" style="display: none;"></ul><script type="text/javascript" src="js/plugin/flot/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.tooltip.min.js"></script><div id="flotTip" style="display: none; position: absolute;"></div><div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><script type="text/javascript" src="js/plugin/flot/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.tooltip.min.js"></script><div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><script type="text/javascript" src="js/plugin/flot/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.tooltip.min.js"></script><script type="text/javascript" src="js/plugin/delete-table-row/delete-table-row.min.js"></script><div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><script type="text/javascript" src="js/plugin/flot/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.tooltip.min.js"></script><script type="text/javascript" src="js/plugin/delete-table-row/delete-table-row.min.js"></script><div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><script type="text/javascript" src="js/plugin/delete-table-row/delete-table-row.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.tooltip.min.js"></script><div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><script type="text/javascript" src="js/plugin/flot/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/plugin/flot/jquery.flot.tooltip.min.js"></script><div class="jvectormap-label"></div></body></html>