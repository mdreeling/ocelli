...
<html>
	...
	<body>
		<a href="#edit-host" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-host" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:hostInstance, action:'update']" method="PUT" >
