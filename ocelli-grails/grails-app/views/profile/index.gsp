		...
		<div id="list-profile" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="profileDescription" title="${message(code: 'profile.profileDescription.label', default: 'Profile Description')}" />
				...
				<g:each in="${profileInstanceList}" status="i" var="profileInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${profileInstance.id}">${fieldValue(bean: profileInstance, field: "profileDescription")}</g:link></td>
